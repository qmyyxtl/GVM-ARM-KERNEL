...
struct page *__alloc_pages_mpol(gfp_t gfp, unsigned int order,
		struct mempolicy *mpol, pgoff_t ilx, int nid, bool use_smart_grid);
...
static inline struct page *__alloc_pages_mpol(gfp_t gfp, unsigned int order,
		struct mempolicy *mpol, pgoff_t ilx, int nid, bool use_smart_grid)
{
...
{
	return __alloc_pages_mpol(gfp, order, mpol, ilx, nid, false);
}
